...
function email_ingest_ensure_schema()
{
    schema_require('incoming email', [
        ...
        'allowed_senders' => ['type', 'value', 'user_id', 'active'],
        'ticket_messages' => [
            'ticket_id', 'direction', 'user_id', 'comment_id', 'sender_email',
            'subject', 'body_text', 'body_html', 'body_html_raw', 'message_id', 'mailbox', 'uid',
        ],
        'ticket_message_attachments' => [
            'ticket_message_id', 'attachment_id', 'filename', 'mime', 'storage_path', 'content_id',
        ],
        'email_ingest_logs' => [
            'mailbox', 'uid', 'message_id', 'sender_email', 'subject', 'ticket_id', 'status',
        ],
