...
$page_view = file_get_contents($root . '/includes/modules/reports/views/page.php');
$billing_view = file_get_contents($root . '/includes/modules/reports/views/billing.php');
$reports = ($page_view === false || $billing_view === false) ? false : $page_view . "\n" . $billing_view;
